 ...
 * @since Jul 30, 2015
 */
public class ArmorListener implements TerminableModule {
    ...
    public void setup(@Nonnull final TerminableConsumer consumer) {
                ...
                .handler(e -> {
                    ...
                    if(shift){
                        ...
                        if(newArmorType != null){
                            ...
                            if(equipping) {
                                if(newArmorType.equals(ArmorType.HELMET) && e.getCurrentItem().getType().name().equalsIgnoreCase("SKULL_ITEM")) return;
                            }
                    ...
                    if(e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
                        ...
                        if(newArmorType != null){
                            if(newArmorType.equals(ArmorType.HELMET) && isAirOrNull(e.getPlayer().getInventory().getHelmet()) || newArmorType.equals(ArmorType.CHESTPLATE) && isAirOrNull(e.getPlayer().getInventory().getChestplate()) || newArmorType.equals(ArmorType.LEGGINGS) && isAirOrNull(e.getPlayer().getInventory().getLeggings()) || newArmorType.equals(ArmorType.BOOTS) && isAirOrNull(e.getPlayer().getInventory().getBoots())){
                                if (newArmorType.equals(ArmorType.HELMET) && e.getItem().getType().equals(Material.PLAYER_HEAD)) return;
        ...
        Events.subscribe(InventoryDragEvent.class, EventPriority.HIGHEST)
                .filter(EventFilters.ignoreCancelled())
                .handler(event -> {
