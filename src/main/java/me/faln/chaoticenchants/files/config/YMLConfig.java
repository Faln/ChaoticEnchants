...
public class YMLConfig {
    ...
    public ItemStackBuilder getItemstack(final String path) {
        return ItemStackBuilder.of(this.material(path + ".material"))
                .name(this.coloredString(path + ".name"))
                .lore(this.coloredList(path + ".lore"))
                .model(this.parseInt(path + ".custom-model-data", 0));
    }
    ...
    public double parseDouble(final String path) {
    ...
    public String coloredString(final String path) {
        return Color.colorize(this.string(path));
    }

    public List<String> coloredList(final String path) {
        return Color.colorize(this.list(path));
    }
}
